...
In Next.js, ALWAYS using Server Components for data fetching. NEVER use Client Components for fetch data.

## 2. Data Fetching Methods

ALWAYS use the helper function in the /data directory to fetch data. NEVER fetch data directly in your components.
